...
const RoleSwitcher: React.FC<RoleSwitcherProps> = ({ onNavigate, onLogout, currentPage, mobileOnly = false }) => {
  ...
  const getUserAvatar = () => {
    ...
    const avatarId = Math.abs(username.split('').reduce((a, b) => a + b.charCodeAt(0), 0)) % 100;
              ...
              <>
                <div className="border-t border-gray-700 py-2">
                  ...
                  <button
                    ...
                    className="w-full flex items-center space-x-3 px-4 py-2 text-indigo-400 hover:bg-gray-700 hover:text-indigo-300 transition-colors"
                  >
